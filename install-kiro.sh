...
echo "  2) 스택별 진입 스킬이 아키텍처 선택을 안내합니다"
echo "       JVM /hx-jvm-setup(8종) · 웹 /hx-web-setup(3종) · Electron /hx-electron-setup(3종)"
echo "       이슈 트래커를 연동하신다면 /hx-jira-setup (선택 모듈 jira-workflow 를 켠 리포에서)"
