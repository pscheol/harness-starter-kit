...
| 설계 원칙(클린 아키텍처·SOLID — Go 관용구 우선) | `.agents/rules/design-principles.md` |
...
| 주석 작성(Go doc 규약 + 기본은 '없음') | `.agents/rules/code-comments.md` |
...
- 주석은 Go doc 규약 + 기본은 '없음': exported에 한 줄, 더 쓰는 건 Why·함정·외부 근거·억제 이유·복잡한 함수의 절차일 때만.
