...
| 파일 | 무엇의 원본인가 | 어디로 복사되나 |
|---|---|---|
| `index.md` | 제품 색인(feature 등록표) | `<slug>-specs/index.md` (제품 최초 생성 시 1회) |
| `requirements/_template.md` | 사용자 스토리 + EARS 수용 기준 | `<slug>-specs/requirements/<feature>.md` |
| `design/_template.md` | 아키텍처·데이터·오류·테스트 설계 | `<slug>-specs/design/<feature>.md` |
| `checklists/_template.md` | 요구사항 품질 판정 체크리스트 | `<slug>-specs/checklists/<feature>-<도메인>.md` |
| `tasks/_template.md` | 실행 가능한 작업 체크리스트 | `<slug>-specs/tasks/active/<feature>.md` |
