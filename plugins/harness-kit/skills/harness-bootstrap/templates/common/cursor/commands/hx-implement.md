...
> SDD 4단계 — 구현. tasks를 Phase 순서로 실행하고 완료 게이트(사용자 승인)를 따른다.

<!-- HARNESS STARTER KIT · 얇은 트리거. 정본: .agents/rules/sdd-workflow.md (/hx-implement 절) -->

SDD 워크플로 **정본** `.agents/rules/sdd-workflow.md` 의 **`/hx-implement`** 절을 로드해 그대로 수행한다.
